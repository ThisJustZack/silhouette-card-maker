...
CYBERPUNK_API_URL_TEMPLATE = 'https://api.netdeck.gg/api/cards/cyberpunk?q={CARD_NAME}&limit=60&offset=0'
...
class CyberpunkImageSearcher(ImageSearcherLike[C]):
    async def find_image(self, card: C) -> Optional[CardImage]:
        ...
        if request_response != None:
            ...
            card_from_response: Mapping[str, Any] = json_response.get('items')[0]
