...
from plugins.cyberpunk.infrastructure.CyberpunkDeckSearcher import CyberpunkDeckSearcher

class CyberpunkTCGURLDeckFormat(DeckFormat[Card]):

    def __init__(self):
        super().__init__()

    async def parse_decklist(self, decklist):
        deck_searcher = CyberpunkDeckSearcher()
